...
//g++ -std=c++11 test2.cc
//g++ -std=c++11 test2.cc
//clang++ -std=c++11 -o b -Xpreprocessor -fopenmp test2.cc 
...
inline double compareDist(const DataFrame& d1,const DataFrame& d2,const size_t& dims){
	double sum=0;
	//cout<<"means1\n";
	//printDF(d1,dims);
	//cout<<"means2\n";
...
pair<DataFrame,vector<size_t>> kmeans(const DataFrame data, size_t k, size_t iterations,double eps, int dimensions) {
